...
public class OverviewAccountsListViewFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.overview_accounts_listview_container, container,
                false);
        Toolbar toolbar = (Toolbar) view.findViewById(R.id.accountListViewToolbar);
        toolbar.setTitle("My Accounts");
        toolbar.inflateMenu(R.menu.accounts_listview_menu);
